...
import { removeToCardProvider } from "../../../../../../app/feature/addToCardStore/AddToCard";
...
function ServiseMainSlice() {

    const dispatch = useDispatch();
    const CurrentDataProvider = useSelector((state) => state.AddToCard.CurrentDataProvider)

    useEffect(() => {
        dispatch(GateDataFetch());
    }, [dispatch, CurrentDataProvider]);

    return (
        <>
            {
                (CurrentDataProvider === null || CurrentDataProvider === undefined) &&
                <ServiceNot navigate={"services"}/>
            }
            {
                ((CurrentDataProvider != null) || (CurrentDataProvider != undefined)) &&
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    < div className="">
                        ...
                        <div className="container mx-auto px-4 py-8" key={CurrentDataProvider._id}>
                            <div className="flex flex-wrap -mx-4">

                                <div className="w-full md:w-1/2 px-4 mb-8">
                                    <ServiceFirstPartInMini product={CurrentDataProvider} />
                                </div>
                                <div className="w-full md:w-1/2 px-4">
                                    <h2 className="text-3xl font-bold mb-2">{CurrentDataProvider.Title}</h2>
                                    <div className="mb-4">
                                    ...
                                    <p className="text-gray-700 mb-6">{CurrentDataProvider.Contern}</p>
                                    <div className="flex space-x-4 mb-6">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                new Promise((resolve) => {
                                                    dispatch(removeToCardProvider(CurrentDataProvider._id));
                                                    resolve();
                                                }).then(() => {
                                                    dispatch(GateDataFetch());
                                                });
...
export default ServiseMainSlice
